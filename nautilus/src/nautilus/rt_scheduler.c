...
static rt_thread_sim *rt_need_resched_logic(rt_scheduler *scheduler, rt_thread *thread, uint64_t time);
...
static rt_thread_sim* rt_need_resched_logic(rt_simulator *scheduler, rt_thread_sim *thread, uint64_t time)
{
    rt_thread_sim *next;
